...
| machine                       |                                                                | On NixOs |
| ----------------------------- | -------------------------------------------------------------- | -------- |
| [hydrogen](machines/hydrogen) | my previous work laptop, now used as backup or testing machine | yes      |
| [helium](machines/helium)     | my current work laptop                                         | yes      |
| [lithium](machines/lithium)   | my mini pc, used as home server                                | not yet  |
